...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.31"])
    s.add_dependency(%q<rubocop-performance>.freeze, ["~> 1.13"])
    s.add_dependency(%q<rubocop-rake>.freeze, [">= 0"])
    s.add_dependency(%q<rubocop-rspec>.freeze, ["~> 2.12"])
